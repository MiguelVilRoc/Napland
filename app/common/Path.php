...
//(Llamado desde el ajaxLink público o su controlador)
    ...
    //const CONTROLLER_DESCARGAR_PDF_AJAX = "../../app/controller/descargarPDF.php";
...
//Librerias
    const LIBS_DOMPDF = "../../app/common/librerias/dompdf/vendor/autoload.php";
...
//JS
    ...
    const PUBLIC_JS_ANIMACION_IMAGEN = "public/js/animacionImagen.js";
    ...
    //PDF
    const PUBLIC_JS_PDF = "public/js/pdf.js";

    //DOCUMENTOS
    const PUBLIC_DOC_TERMINOS = "public/doc/Napland Terminos y Condiciones.pdf";
