...
<div>
  <button type="button" id="btnDescargarPDF" name="btnDescargarPDF" class="btn btn-danger" onclick="generarPDF('Listado de Usuarios')">Descargar PDF</button>
</div>
<!--Tabla de usuarios-->
<div class="table-responsive">
<table class="table descargarPDF" id="table-usuarios">
    <tr>
    <th>Email</th>
    <th>Nombre</th>
    <th>Apellidos</th>
