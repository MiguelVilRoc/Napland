...
<table id="tablaCarrito" class="table">
    ...
    ?>
        <tr class="lineaProducto" data-id="<?=$producto->getId()?>">
            ...
            <td class="centrado">
                <button class="d-md-none btn btn-primary btn-carrito mb-3" type="button" onclick="incrementarCantidad(<?=$producto->getId()?>)">+</button>  
                <button class="d-md-none btn btn-primary btn-carrito" type="button" onclick="disminuirCantidad(<?=$producto->getId()?>)">-</button>
                

                <button class="d-none d-md-inline-block btn btn-primary btn-carrito" type="button" onclick="disminuirCantidad(<?=$producto->getId()?>)">-</button>
                <button class="d-none d-md-inline-block btn btn-primary btn-carrito" type="button" onclick="incrementarCantidad(<?=$producto->getId()?>)">+</button>  
            </td>
